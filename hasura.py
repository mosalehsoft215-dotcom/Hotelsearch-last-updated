...
class HotelStaticData(_Loose):
    ...
    addressLines: list[str] | None = None
    postalCode: str | None = None
    geoLocation: str | None = None          # "lat,lon"
    checkInTime: str | None = None
    checkOutTime: str | None = None
    giataCityId: int | None = None
    lastUpdate: str | None = None
    medias: list[str] | None = None         # HotelObj.medias is [String]
    phones: list[HotelPhone] | None = None
    descriptions: list[Any] | None = None
    facilities: list[str] | None = None     # HotelObj.facilities is [String]
...
class HotelOptionsResult(_Loose):
    """Return of `getHotelFullOptions`. Its `options` field is [RoomSearch] —
    the same rooms/roomsOptions pair the availability call returns — so it is
    flattened into the same one-record-per-bookable-choice shape."""
    hotelId: str | None = None
    uuid: str | None = None
    errors: list[Any] | None = None
    options: list[HotelRoomOption] | None = None
